...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-light ">
		<a class="nav-link disabled">
			<div class="aaa">
				<img src="../image/空.jpg" width="30" height="30"class="d-inline-block align-top" alt=""> 卒研ページ
			</div>
		</a>
...
<body>
	<form action="/sotuken-project/SignInServlet" method="get">
		...
		<div class="form-group col-md-12">
			<label>アカウントID</label> 
			<input type="text"class="form-control" name="id" placeholder="作成したいアカウントIDを入力...">
		</div>
		<div class="form-group col-md-12">
			<label>アカウント名</label> 
			<input type="text"class="form-control" name="name"placeholder="アカウント名の入力...">
		</div>
		<div class="form-group col-md-12">
			<label>メールアドレス</label> 
			<input type="email"class="form-control" name="mail"aria-describedby="emailHelp" placeholder="メールアドレスの入力...">
		</div>
		<p>生年月日</p>
...
>>>>>>> 9ebc2f92106b3f15d04889a8d142dd0277876ca7
		...
		<div class="form-group col-md-12">
			<label>パスワード</label> 
			<input type="password" class="form-control" id="exampleInputPassword1"placeholder="パスワードの入力..."> <input type="password"	class="form-control" name="password"placeholder="パスワードの再入力...">
		</div>
		<div class="form-group col-md-12">
			<label>電話番号</label> 
			<input type="text"class="form-control" name="tell" placeholder="電話番号の入力...">
		</div>
		<input type="hidden" name="token" value="sessions">
		<div>
			<input type="submit" class="btn btn-primary"style="margin-bottom: 5px;" value="アカウント登録">
		</div>
	</form>
</body>
</html>