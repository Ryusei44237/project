        ...
        <div class="modal-body" style="width: 750px;">
          <form>
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="投稿内容入力">
      ...
      <div class="row">
        <div class="col-3" style="width: 160px;">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link " id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="false" style="width: 155px;">環境設定</a>
            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="true" style="width: 155px;">ガイドライン</a>
            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="true" style="width: 155px;">ログアウト</a>
          </div>
        </div>
        <div class="col-9">
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" style="width: 800px;">

              <form method="post" action="example.cgi">

                <p>テーマ選択<br>
                <input type="radio" name="q1" value="ホワイト"> ホワイト
                <input type="radio" name="q1" value="ダーク"> ダーク
                </p>

                <p>住所表示選択<br>
                <input type="radio" name="q2" value="はい"> 表示
                <input type="radio" name="q2" value="いいえ" checked> 非表示
                </p>

                <p>電話番号表示選択<br>
                <input type="radio" name="q3" value="はい"> 表示
                <input type="radio" name="q3" value="いいえ" disabled> 非表示
                </p>

                <p><input type="submit" value="設定を保存する"></p>
...
<!-- hedear開始 -->
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="toppage.html">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link " href="sign-up.html">登録</a>
          </li>
          <li class="nav-item active">
        ...
        <div class="searchform">
          <form class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2" type="search" placeholder="キーワード入力" aria-label="Search">
  ...
  -->
  <div class="home-page">
    <img src="../image/沖縄海.jpg" alt="ユーザのトップ画像" class="rounded-circle" style="height: 100px;width: 100px;">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">過去投稿</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">画像一覧</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">アカウント管理</a>
      </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        ...
        <table class="table">
          <tbody>
            <tr>
              ...
              <td>
                <img src="../image/沖縄海.jpg" alt="ユーザのトップ画像" class="rounded-circle" style="margin-left: 0px; height: 30px;width: 30px;">
                user name @acount id
                <p class="text-justify">今日は初めまして</p>
                <!--twitter-->
      ...
      <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <div class="insta">
          <div>
              <a>
                  <img src="../image/空.jpg" class="img-circle">
          ...
          <form>
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationServer01">苗字</label>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                <label for="validationServer03">住所</label>
              ...
              <div class="col-md-3 mb-3">
                <label for="validationServer04">メールアドレス</label>
                <input type="text" class="form-control is-invalid" id="validationServer04" placeholder="〇〇〇@example.com" required>
                <div class="invalid-feedback">
                  メールアドレスを入力してください。
                </div>
              </div>
              <div class="col-md-3 mb-3">
                <label for="validationServer05">ユーザーID</label>
                <input type="text" class="form-control is-invalid" id="validationServer05" placeholder="ユーザーID" required>
                <div class="invalid-feedback">
                  ユーザーIDを入力してください。
                </div>
              </div>
